                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center">
                                <button class="btn btn-sm btn-warning " onclick="editPengurus('<?= $data['idpengurus']; ?>')">
                                    <i class="fas fa-fw fa-pen"></i> Edit
                                </button>
                                <button class="btn btn-sm btn-danger mx-1" onclick="deletePengurus('<?= $data['idpengurus']; ?>')">
...
<script>
    function editPengurus(nip) {
        window.location.href = '<?= base_url('pengurus/edit/') ?>' + idpengurus;
    }
    function deletePengurus(nip) {
        ...
        if (confirm('Apakah Anda yakin ingin menghapus pengurus dengan nip ' + nip + '?')) {
            ...
            var deleteUrl = '<?= base_url('pengurus/hapus/') ?>' + idpengurus;
